...
const { isOpen, data, close } = useDialogManager<Department>('delete-department');
</script>
        ...
        <AlertDialogContent>
            <div class="flex flex-col gap-2 max-sm:items-center sm:flex-row sm:gap-4">
                ...
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        ...
                        <span v-if="data" class="font-medium">{{ data.name }}</span>
            ...
            <AlertDialogFooter>
                ...
                <AlertDialogAction asChild>
                    <Form
                        v-if="data"
                        :action="DepartmentController.destroy(data.id)"
                        :onSuccess="() => close()"
                    >
